## CYBR4580 Project Milestone 1 - Project Proposal: Requirements analysis and planning
...
- [Literature Review](#literature-review) - What have others done to inform your idea? What other ideas can you build upon?
- [Project Methodology](#project-methodology) - What are you going to do? How are you going to do it?
...
## Literature Review
Reinventing the wheel or trying to tackle a problem without first understanding what others have done is a fool's errand. To ensure your project idea is sound and builds on the work of others, you must conduct a literature review as part of your proposal and planning process. The goal of the literature review is to identify relevant tools, techniques, other works, and similar resources that will aide and inform your efforts - and help you construct and refine your methodology.

### Submission materials
For milestone 1, you should prepare a literature review document that surveys the various research and development work in your project area. Create a file on your GitHub repository titled `litreview.md`. This document should identify important `keywords`, relevant `research papers` and `tools`, and `the state of the art` in your area. Make sure to follow the [structured abstract template](./structured-abstract-template.md).

### Grading Criteria
Your literature review will be graded as follows.
...
## Project Methodology
Methodology is extremely important for conducting a successful project. While I am always a fan of "winging it" when it comes to day-to-day life - winging it is not an option for being successful on a team. Hence, in this class you will be required to develop a technical plan (AKA `Methodology`). Your methodology should be grounded in scientific method and best practice. It should be informed by your literature review - using well-tested methods and best practices.

### Submission materials
Once you have examined the relevant literature, you should prepare a technical plan that outlines and defines your methodology. This technical plan should provide a detailed description of exactly what you plan to do and how you plan to do it.

Data collection techniques, testing/development methods, software/network architectures, data analysis techniques, and/or modeling methodology (like use/misuse cases, assurance cases, or UML diagramming) are all relevant items to be included in your methodology write-up. 

Your goal is to communicate the process that you plan to follow.
...
## First Sprint Plan
This milestone represents the first step forward in your capstone project. As part of that effort, you need to plan for your first week of actually starting the work. We will use Sprint / Agile-like methods to track your progress and organize your project management artifacts. In particular, you will use GitHub Issues to do this.
...
## Presentation Video
You will be expected to present your Milestone 1 proposal to the class. It is important that you use this time to inform your classmates and get feedback. Things to be considered are 1) conveying a sense of interest and excitement about your project, 2) soliciting feedback from peers that might be useful for development or refinement of your project, and 3) presenting your methodology and scope to get recommendations from peers and the instructor.

### Submission Materials
You will record your presentation as a video using VidGrid. Post the video to the canvas submission page AND in the slack `#fa-2020-general` chat.
...
## Teamwork
Lastly, it is important that you realize you are working on a TEAM. To reiterate what is in the syllabus - your grade is dependent on your participation. I will not allow individuals to sluff off on a team. Your grade is therefore based partly on a *participation factor*. Essentially if you don't participate (and trust me I will know) - you will not get all of the team points on your project grade.
