...
**Assigned: Thursday 4/13/17**

380 Total Points

## Due Date
Thursday May 3rd (5/3/18) at 11:59pm
Presentations Tuesday May 1st (5/1/18) at 5pm
**No Extensions will be given!!!**

## Overview
This project milestone tasks you with producing your final major deliverable. Since every project is different the requirements stated below are as generally applicable as possible.
...
- [Packaging and Release](#packaging-and-release) - Package all of your product deliverables, results, and outcomes for release
- [Presentation](#presentation) - Present your progress to the class and your external partner
...
### Submission materials
For this submission, you should submit your final report as a `.md` file called `finalreport.md` in your project GitHub repository. You should also convert the md file to pdf and upload it as `finalreport.pdf` for use on other non-web-based file stores. 
...
|Activity and Findings Summary| Findings from project activities have been summaried at a high level and are presented in a tabular or graphical format that is easy to read and understand. | Findings are missing from the summary or are difficult to read and understand as presented. | Little or no efforts were made to summarize findings. |
...
## Presentation
You will be expected to present your Final Milestone to the class on our final day. There may be external guests present as well. A project presentation agenda will be released before the presentation day. Project teams will have 20 minutes to present. 
...
### Submission Materials
Submit your slides to Drs. Hale / Mahoney as part of your overall submission on the day of the presentation. Submit them by uploading them in your project github repository.
